...
export function SandboxModal({ isOpen, onClose, onRefresh }: SandboxModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl border border-stone-800 bg-stone-900 p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="space-y-2.5 pt-1">
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-xl bg-stone-950 hover:bg-stone-800 border border-stone-800 text-left transition group"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-rose-600/20 text-rose-400 border border-rose-500/30 group-hover:scale-105 transition">
