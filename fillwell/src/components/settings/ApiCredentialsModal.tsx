...
export function ApiCredentialsModal({ isOpen, onClose }: ApiCredentialsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="w-full max-w-lg rounded-2xl border border-stone-800 bg-stone-900 p-6 shadow-2xl space-y-4 my-8">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="p-3.5 rounded-xl bg-stone-950 border border-stone-800 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-stone-500 font-mono">AI Studio Key</span>
            </div>
            <input
              type="password"
              value={geminiKey}
              ...
              placeholder="AIzaSy..."
              className="w-full rounded-lg bg-stone-900 border border-stone-800 px-3 py-1.5 text-xs text-stone-100 font-mono outline-none focus:border-rose-500"
            />
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-stone-950 border border-stone-800 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-stone-500 font-mono">WebRTC Voice AI</span>
            </div>
            <input
              type="password"
              value={vapiKey}
              ...
              className="w-full rounded-lg bg-stone-900 border border-stone-800 px-3 py-1.5 text-xs text-stone-100 font-mono outline-none focus:border-cyan-500"
            />
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-stone-950 border border-stone-800 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="text-[10px] text-stone-400 block mb-1">Account SID</label>
                <input
                  type="text"
                  value={twilioSid}
                  onChange={(e) => setTwilioSid(e.target.value)}
                  placeholder="AC..."
                  className="w-full rounded-lg bg-stone-900 border border-stone-800 px-2.5 py-1.5 text-xs text-stone-100 font-mono outline-none focus:border-purple-500"
                />
              </div>
              <div>
                <label className="text-[10px] text-stone-400 block mb-1">Auth Token</label>
                <input
                  type="password"
                  value={twilioToken}
            ...
            <div>
              <label className="text-[10px] text-stone-400 block mb-1">Assigned Twilio Number</label>
              <input
                type="text"
                value={twilioPhone}
          ...
          <div className="p-3.5 rounded-xl bg-stone-950 border border-stone-800 space-y-2">
            ...
            <input
              ...
              className="w-full rounded-lg bg-stone-900 border border-stone-800 px-3 py-1.5 text-xs text-stone-100 font-mono outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-stone-800">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-1.5 px-5 py-2 rounded-xl bg-gradient-to-r from-rose-600 to-purple-600 hover:opacity-95 text-xs font-bold text-white shadow-lg shadow-rose-600/25 transition disabled:opacity-50"
            >
