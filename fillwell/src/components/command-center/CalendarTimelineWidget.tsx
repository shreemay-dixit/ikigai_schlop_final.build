...
export function CalendarTimelineWidget() {
  ...
  return (
    <div className="rounded-xl border border-stone-800 bg-stone-900/60 p-4 shadow-xl space-y-3">
      ...
      <div className="flex gap-1.5 overflow-x-auto pb-1 scrollbar-none">
        {slots.slice(0, 12).map((s) => (
          ...
          >
            ...
            <div className={`text-[9px] ${s.is_available ? "text-stone-500" : "text-rose-400"}`}>
