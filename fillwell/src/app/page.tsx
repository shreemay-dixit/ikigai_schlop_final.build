...
export default function RootPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f8] text-stone-900 font-sans selection:bg-rose-200">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-12 py-4 bg-white/70 backdrop-blur-md border-b border-rose-100">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-black tracking-tight text-stone-800">Fillwell</span>
        </div>
        <div className="flex items-center gap-4">
          <Link href="/login" className="text-sm font-semibold text-stone-600 hover:text-rose-500 transition-colors">Clinic Login</Link>
          <Link href="/book" className="hidden sm:inline-flex items-center gap-1.5 rounded-full bg-stone-900 px-4 py-2 text-sm font-bold text-white transition hover:bg-stone-800 shadow-lg shadow-stone-200">
            Book Appointment
          </Link>
        </div>
      </nav>
      ...
      <main className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left z-10 animate-page-in">
            <h1 className="text-5xl lg:text-7xl font-black tracking-tight text-stone-900 leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <Link href="/book" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border-2 border-stone-200 bg-white/50 px-8 py-4 text-base font-bold text-stone-700 backdrop-blur-sm transition-all hover:border-rose-200 hover:bg-white hover:text-rose-600">
                Schedule for Later
              </Link>
            </div>
            
            <div className="pt-8 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm font-semibold text-stone-500">
          ...
          <div className="w-full max-w-md lg:w-[480px] shrink-0 animate-page-in" style={{ animationDelay: "150ms" }}>
            <div className="relative rounded-[2rem] border border-white/50 bg-white/60 p-8 shadow-2xl shadow-rose-500/10 backdrop-blur-xl">
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-6">
                <div className="space-y-2">
                  <h2 className="text-2xl font-black text-stone-800">Scan to Check-In</h2>
                ...
                <div className="group relative rounded-3xl border-4 border-rose-100 bg-white p-6 shadow-sm transition-transform hover:scale-105 hover:border-rose-200">
                  ...
                  {portalUrl ? (
                    ...
                    <div className="w-[180px] h-[180px] flex items-center justify-center bg-stone-50 rounded-xl">
                      <div className="h-8 w-8 animate-spin rounded-full border-4 border-rose-200 border-t-rose-500" />
                    </div>
                  )}
                </div>
                
                <div className="grid grid-cols-2 gap-4 w-full pt-4 border-t border-stone-100">
                  <div className="flex flex-col items-center gap-1">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-rose-50 text-rose-500 mb-1">
                      <Clock className="h-5 w-5" />
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Avg Wait</span>
                    <span className="text-lg font-black text-stone-700">&lt; 15m</span>
                  </div>
                  <div className="flex flex-col items-center gap-1">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-blue-500 mb-1">
                      <ShieldCheck className="h-5 w-5" />
                    </div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Privacy</span>
                    <span className="text-lg font-black text-stone-700">HIPAA</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <Link href="/standby" className="lg:hidden mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-stone-900 px-6 py-4 text-sm font-bold text-white shadow-lg">
