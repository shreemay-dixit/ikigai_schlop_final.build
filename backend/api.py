...
# Robust model path resolution: checks ml/models/ first, then project root fallback
MODEL_CANDIDATES = [
    os.path.join(PROJECT_ROOT, "ml", "models", "wait_predictor_cv.pkl"),
    os.path.join(PROJECT_ROOT, "wait_predictor_cv.pkl"),
]
